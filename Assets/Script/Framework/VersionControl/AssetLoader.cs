...
namespace Config
{
    public class AssetLoader : MonoBehaviour
    {
        ...
        #region Singleton
        static AssetLoader sInstance = null;
        ...
        public static AssetLoader Singleton
        {
            get
            {
                if (sInstance == null)
                {
                    GameObject tmpRoot = GameObject.Find("GameMgr");
                    sInstance = tmpRoot.GetComponent<AssetLoader>();
                    if (null == sInstance)
                    {
                        sInstance = tmpRoot.AddComponent<AssetLoader>();
                    }
                }
                return sInstance;
            }
