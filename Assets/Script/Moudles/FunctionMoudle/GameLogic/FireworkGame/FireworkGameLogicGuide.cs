...
public class FireworkGameLogicGuide : SingletonTemplateMon<FireworkGameLogicGuide> {
	...
	private UIWindowFireworkGuide m_Window;
	...
	{
		m_Window = (UIWindowFireworkGuide) WindowManager.Instance.GetWindow(WindowID.FireworkGuide);
	}
