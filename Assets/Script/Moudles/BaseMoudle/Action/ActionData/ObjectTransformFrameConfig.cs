...
namespace ActionEditor
{
  ...
  [Serializable]
  #endif
  public partial class ObjectTransformFrameConfig : TBase
  {
    ...
    public ObjectTransformFrameConfig() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("ObjectTransformFrameConfig");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("ObjectTransformFrameConfig(");
      sb.Append("Pos: ");
