...
namespace ActionEditor
{
  ...
  [Serializable]
  #endif
  public partial class AddNpcFrameConfig : TBase
  {
    private int _id;
    private int _tempId;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("AddNpcFrameConfig");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("AddNpcFrameConfig(");
      sb.Append("Id: ");
      sb.Append(Id);
      sb.Append(",TempId: ");
      sb.Append(TempId);
