...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCArmyInfoChangeMsg : TBase
  {
    private int _gold;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCArmyInfoChangeMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCArmyInfoChangeMsg(");
      sb.Append("Gold: ");
      sb.Append(Gold);
      sb.Append(",Level: ");
      sb.Append(Level);
