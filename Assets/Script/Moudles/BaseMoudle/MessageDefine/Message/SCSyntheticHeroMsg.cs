...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCSyntheticHeroMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCSyntheticHeroMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCSyntheticHeroMsg(");
