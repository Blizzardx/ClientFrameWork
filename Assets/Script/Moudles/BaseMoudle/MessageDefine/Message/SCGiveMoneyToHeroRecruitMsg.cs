...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCGiveMoneyToHeroRecruitMsg : TBase
  {
    ...
    public SCGiveMoneyToHeroRecruitMsg() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCGiveMoneyToHeroRecruitMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCGiveMoneyToHeroRecruitMsg(");
