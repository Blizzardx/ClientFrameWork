...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCAddBlackNameMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCAddBlackNameMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCAddBlackNameMsg(");
