...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCAddFriendMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCAddFriendMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCAddFriendMsg(");
