...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCHeroSkillQualityLevelUpMsg : TBase
  {
    ...
    public SCHeroSkillQualityLevelUpMsg() {
    }
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCHeroSkillQualityLevelUpMsg(");
