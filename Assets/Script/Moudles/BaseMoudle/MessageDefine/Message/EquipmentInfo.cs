...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class EquipmentInfo : TBase
  {
    private int _templateId;
    private long _uniqueId;
    private long _putOnUid;
    private short _strengthenLevel;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("EquipmentInfo");
      ...
      if (__isset.strengthenLevel) {
        field.Name = "strengthenLevel";
        field.Type = TType.I16;
        field.ID = 40;
        oprot.WriteFieldBegin(field);
        oprot.WriteI16(StrengthenLevel);
        oprot.WriteFieldEnd();
      }
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("EquipmentInfo(");
