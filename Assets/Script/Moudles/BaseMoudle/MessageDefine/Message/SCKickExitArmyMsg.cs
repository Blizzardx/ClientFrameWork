...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCKickExitArmyMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCKickExitArmyMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCKickExitArmyMsg(");
