...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCHeroStarLevelUpMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCHeroStarLevelUpMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCHeroStarLevelUpMsg(");
