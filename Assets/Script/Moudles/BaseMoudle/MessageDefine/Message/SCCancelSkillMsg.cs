...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCCancelSkillMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCCancelSkillMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCCancelSkillMsg(");
      sb.Append("SkillId: ");
      sb.Append(SkillId);
