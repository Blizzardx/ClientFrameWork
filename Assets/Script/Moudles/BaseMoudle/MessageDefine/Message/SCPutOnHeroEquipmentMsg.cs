...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCPutOnHeroEquipmentMsg : TBase
  {
    ...
    public SCPutOnHeroEquipmentMsg() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCPutOnHeroEquipmentMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCPutOnHeroEquipmentMsg(");
