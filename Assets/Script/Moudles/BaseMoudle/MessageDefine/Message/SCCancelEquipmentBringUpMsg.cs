...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCCancelEquipmentBringUpMsg : TBase
  {
    ...
    public SCCancelEquipmentBringUpMsg() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCCancelEquipmentBringUpMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCCancelEquipmentBringUpMsg(");
