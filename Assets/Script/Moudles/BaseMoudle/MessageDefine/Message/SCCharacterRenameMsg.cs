...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCCharacterRenameMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCCharacterRenameMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCCharacterRenameMsg(");
