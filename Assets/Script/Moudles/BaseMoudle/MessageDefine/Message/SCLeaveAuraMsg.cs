...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCLeaveAuraMsg : TBase
  {
            ...
            if (field.Type == TType.List) {
              {
                ...
                for( int _i53 = 0; _i53 < _list52.Count; ++_i53)
                {
                  ...
                  AffectUniqueIdList.Add(_elem54);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCLeaveAuraMsg");
      ...
      if (AffectUniqueIdList != null && __isset.affectUniqueIdList) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (long _iter55 in AffectUniqueIdList)
          {
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCLeaveAuraMsg(");
