...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SimpleArmyInfo : TBase
  {
    private int _id;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SimpleArmyInfo");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SimpleArmyInfo(");
      sb.Append("Id: ");
      sb.Append(Id);
      sb.Append(",Name: ");
      sb.Append(Name);
