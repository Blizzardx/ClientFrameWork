...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCCompleteMission : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCCompleteMission");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCCompleteMission(");
