...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCDelBuffMsg : TBase
  {
            ...
            if (field.Type == TType.List) {
              {
                ...
                for( int _i41 = 0; _i41 < _list40.Count; ++_i41)
                {
                  ...
                  TargetUniqueIdList.Add(_elem42);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCDelBuffMsg");
      ...
      if (TargetUniqueIdList != null && __isset.targetUniqueIdList) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (long _iter43 in TargetUniqueIdList)
          {
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCDelBuffMsg(");
      sb.Append("UniqueId: ");
      sb.Append(UniqueId);
      sb.Append(",BuffId: ");
      sb.Append(BuffId);
