...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCApplyJoinArmyMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCApplyJoinArmyMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCApplyJoinArmyMsg(");
