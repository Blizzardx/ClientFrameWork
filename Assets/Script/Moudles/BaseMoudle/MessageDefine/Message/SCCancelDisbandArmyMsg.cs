...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCCancelDisbandArmyMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCCancelDisbandArmyMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCCancelDisbandArmyMsg(");
