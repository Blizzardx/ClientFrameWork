...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCGiveGiftToHeroRecruitMsg : TBase
  {
    ...
    public SCGiveGiftToHeroRecruitMsg() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCGiveGiftToHeroRecruitMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCGiveGiftToHeroRecruitMsg(");
