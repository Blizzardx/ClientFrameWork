...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCApplyDisbandArmyMsg : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCApplyDisbandArmyMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCApplyDisbandArmyMsg(");
