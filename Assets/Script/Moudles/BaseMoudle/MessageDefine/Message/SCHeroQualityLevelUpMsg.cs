...
namespace NetFramework.Auto
{
  ...
  [Serializable]
  #endif
  public partial class SCHeroQualityLevelUpMsg : TBase
  {
    ...
    public SCHeroQualityLevelUpMsg() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("SCHeroQualityLevelUpMsg");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("SCHeroQualityLevelUpMsg(");
