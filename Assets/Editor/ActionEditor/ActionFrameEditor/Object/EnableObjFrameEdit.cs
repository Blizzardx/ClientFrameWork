...
public class EnableObjFrameEidt : AbstractFrameEdit
{
    #region Property
    static public EnableObjFrameEidt Instance
    {
        get
        {
            if (null == m_Instance)
    ...
    private static EnableObjFrameEidt m_Instance;
    ...
    {
        m_Instance = EditorWindow.GetWindow<EnableObjFrameEidt>(false, "启动", true);
    }
    #endregion
}
