...
public class ScreenRaycaster : MonoBehaviour
{
    ...
    /// </summary>
    public LayerMask IgnoreLayerMask = (1 << LayerMask.NameToLayer("StaticEntity")) | (1 << LayerMask.NameToLayer("StaticEntity_MoveCamra")) | (1 << LayerMask.NameToLayer("StaticEntity_Transparent"));
