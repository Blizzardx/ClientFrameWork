...
public class UIEventListener : MonoBehaviour
{
	...
	public delegate void VoidDelegateEx (GameObject go, object param);
	...
	public VoidDelegateEx onClickEx;
	...
	void OnClick ()					{ if (onClick != null) onClick(gameObject); if( null != onClickEx ) onClickEx(gameObject, parameter); }
	...
	static public UIEventListener Get (GameObject go, object param)
	{
		UIEventListener listener = go.GetComponent<UIEventListener>();
		if (listener == null) listener = go.AddComponent<UIEventListener>();
